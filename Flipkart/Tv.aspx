...
<div class="col">   
  ...
  <div class="col">   
    ...
    <asp:label runat="server"  text="TELEVISION"   Font-Size="Large" Font-Underline="True" ForeColor="#0066FF" TabIndex="1" Font-Bold="True"></asp:label>
          </div>
   <br /> 
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row" style="">
                            <div class="text-center mx-auto col-lg-12 col-12">
                                ...
                                <asp:Image class="card-img" ImageUrl='<%# Eval("img")%>' runat="server" Height="250" Width="350" />
