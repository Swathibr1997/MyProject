          ...
          <nav class="navbar navbar-expand-sm bg-primary navbar-dark" draggable="true">
            ...
            <div class="col-sm-4">
                <ul class="navbar-nav justify-content-end">
                    <li class="nav-item">
                          <asp:Label class="nav-link"  ID="lblMsg" runat="server" Font-Size="Large" ForeColor="White" Font-Bold="True"></asp:Label>
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="Home.aspx"><i class="fas fa-sign-out-alt text-white" >LogOut</i></a>&nbsp;&nbsp;
                    </li>
